...
namespace RentalManagementFinalProject.Controllers
{
    ...
    public class StatusController : Controller
    {
        ...
        public StatusController(RentalManagementDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StatusId,Description")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StatusId,Description")] Status status)
        {
